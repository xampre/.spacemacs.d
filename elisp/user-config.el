...
(define-key evil-motion-state-map " o" 'helm-kpth-items)
(define-key evil-motion-state-map " I" 'iedit-mode)
...
(add-to-list 'fringe-styles
             (list "left-display20%" (floor (* (display-pixel-width) 0.2))))
